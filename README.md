...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    describe() - describes what a test does
             - contains nested it()s
             it() - groups tests for readability within describe()

1. What is the point of `Test Driven Development`? What do you think about this approach?

    - Prevents errors and unintended side-effects
    - Ensures the integrity of large apps throughout the life of the app. 
